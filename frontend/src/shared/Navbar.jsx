    ...
    <div className="flex items-center justify-center gap-6">
      {user ? (
        <div className="flex gap-5">
          <Link to="/">
            <BiSolidHome className="h-8 w-8 text-white" />
          </Link>
        ...
        <div className="flex gap-4">
          <Link to="/login">
            <button className="text-gray-900 bg-white px-4 py-2 text-sm rounded-lg hover:bg-blue-600 transition duration-200">
              Login
            </button>
          </Link>
          <Link to="/register">
            <button className="text-white bg-gray-800 px-4 py-2 text-sm rounded-lg hover:bg-green-600 transition duration-200">
              Signup
            </button>
          </Link>
        </div>
